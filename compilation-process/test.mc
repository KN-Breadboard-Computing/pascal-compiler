...
mov A to absolute zero page memory 0b10001101
mov immediate to A 0b00000000
mov A to absolute zero page memory 0b10001001
mov immediate to A 0b00000000
...
mov absolute zero page to A 0b10001101
mov A to absolute zero page memory 0b10001111
mov absolute zero page to A 0b10001001
mov A to absolute zero page memory 0b10001011
mov absolute zero page to A 0b10000111
mov A to absolute zero page memory 0b10001000
mov absolute zero page to A 0b10000101
mov A to absolute zero page memory 0b10000110
label bb7
mov absolute zero page to A 0b10001111
mov immediate to B 0b00001001
mov A-B to A
mov A to absolute zero page memory 0b10000100
mov absolute zero page to A 0b10000100
mov 0 to B
save flags of A-B
...
mov absolute zero page to A 0b10001111
mov A to absolute zero page memory 0b10001101
mov absolute zero page to A 0b10001011
mov A to absolute zero page memory 0b10001001
mov absolute zero page to A 0b10001000
mov A to absolute zero page memory 0b10000111
...
mov immediate to B 0b00001001
mov A+B to A
mov A to absolute zero page memory 0b10001110
mov absolute zero page to A 0b10001001
mov A to absolute zero page memory 0b10001010
label bb10
mov immediate to A 0b00000000
mov A to absolute zero page memory 0b10001100
label bb20
mov absolute zero page to A 0b10001110
...
label bb12
mov absolute zero page to A 0b10001100
...
label bb22
mov absolute zero page to A 0b10001010
...
label bb9
mov absolute zero page to A 0b10001000
mov absolute zero page to B 0b10001100
mov A+B to A
mov A to absolute zero page memory 0b10001000
mov absolute zero page to A 0b10001111
mov immediate to B 0b00000001
