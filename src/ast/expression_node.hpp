...
class ExpressionNode : public AstNode {
 public:
  ...
  ExpressionNode(Operation operation, const std::string &inferredType) : AstNode{Type::EXPRESSION},
																		 operation_{operation},
																		 inferredType_{inferredType} {}
  ExpressionNode(ExpressionNode *left, Operation operation, const std::string &inferredType) : AstNode{
	  Type::EXPRESSION}, operation_{operation}, left_{left}, inferredType_{inferredType} {}
  ExpressionNode(ExpressionNode *left, ExpressionNode *right, Operation operation, const std::string &inferredType)
	  : AstNode{Type::EXPRESSION}, operation_{operation}, left_{left}, right_{right}, inferredType_{inferredType} {}
...
class SpecialExpressionNode : public ExpressionNode {
 public:
  ...
  SpecialExpressionNode(AstNode *argument1,
						AstNode *argument2,
