...
class RoutineBodyNode : public AstNode {
 public:
  ...
  explicit RoutineBodyNode(CompoundStatementNode *statements)
  ...
  [[nodiscard]] const std::unique_ptr<CompoundStatementNode> &getStatements() const {
	return statements_;
  }

  void setStatements(std::unique_ptr<CompoundStatementNode> statements) {
