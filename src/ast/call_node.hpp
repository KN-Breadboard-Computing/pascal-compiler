...
class CallNode : public StatementNode {
 public:
  ...
  CallNode() : StatementNode{Category::CALL} {}
  explicit CallNode(CallObjectType callObjectType) : StatementNode{Category::CALL}, callObjectType_{callObjectType} {}
...
class BuiltinCallNode : public CallNode {
 public:
  ...
  BuiltinCallNode(FunctionName name, ArgumentsListNode* arguments) : CallNode{BUILTIN}, name_{name}, arguments_{arguments} {}
  ...
  [[nodiscard]] FunctionName getFunctionName() const { return name_; }
  [[nodiscard]] const std::unique_ptr<ArgumentsListNode>& getArguments() const { return arguments_; }
